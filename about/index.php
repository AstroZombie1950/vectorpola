	...
	<section class="section">
		<div class="container inner-content">
			...
			<div class="info-grid">
				...
				<div class="info-block">
					<h2>Ассортимент</h2>
					<p>В салоне представлены образцы напольных покрытий разных типов, оттенков и фактур. Вы увидите материал вживую, сравните и оцените, как он впишется в интерьер.</p>
					<p>При необходимости специалист приедет с образцами к вам домой или в офис, чтобы вы могли оценить цвет и фактуру при реальном освещении.</p>
				</div>
